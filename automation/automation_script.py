...
def run_simulation():
    try:
        ...
        # Build the path to the CAD model (assumed to be in IGES format)
        cad_file = os.path.join(os.path.dirname(__file__), '..', 'data', 'differential_piece.iges')
        ...
        output_csv = os.path.join(os.path.dirname(__file__), '..', 'data', 'differential_piece_stress_results.csv')
